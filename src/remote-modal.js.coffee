#
# jQuery Remote Modal Plugin
#
# Usage:
#   <a href="somepage.html" data-remote-modal="true">Show Modal</a>
#
#   <a href="#some-id" data-remote-modal="true">Show Modal</a>
#
# Requires:
#   spin.js
#
...
# Connect the modal to jquery click event
$.fn.remoteModal = (settings) ->
  $(this).each ->
    modal = new RemoteModal $(this), settings
...
# Activate plugin on all data-remote-modal elements
$ -> $("[data-remote-modal]").remoteModal();